...
class _MyHomeState extends State<MyHome> {
  ...
  void initState() {
    ...
    var JiosaavnAudioSourcePlugin = plugin.JiosaavnAudioSourcePlugin;
    var metadata = JiosaavnAudioSourcePlugin()
    """);
  }
                ...
                onPressed: () async {
                  final result = await getIt<Hetu>().eval("""
                      metadata.audioSource.streams({
                        'externalUri': 'ID2ieOjCrwfgWvL5sXl4B1ImC5QfbsDynGcUMFViRyT6NjcPRT2rNlv3BiAfJMS188Y2dl8tOYnRQYEvCcnEzBw7tS9a8Gtq',
                      }.toJson())
                    """);
                  debugPrint(result.toString());
                },
